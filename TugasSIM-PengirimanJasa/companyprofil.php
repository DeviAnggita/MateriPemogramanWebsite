  ...
  <div class="container pt-md-50 pt-15 pb-20">
    <div class="row">
      <div class="col-md-15">
        <br>
        <br>
        <img src="image/CompanyProf.png" class="mx-auto d-block" alt="" width="35%">
        <br>
        <br>
      </div>
      ...
      <div class="isi" style="position: relative; left: 120px; width: 90%; ">
        ...
        <h4 class="bg-primary text-white" style="width: 90%;">Committed to utilizing sophisticated
          IT systems </h4>
        <ul>
        ...
        <h4 class="bg-primary  text-white" style="width: 90%;">OUR SERVICE</h4>
        <ul>
        ...
        <h4 class="bg-primary text-white" style="width: 90%;">OUR Vision</h4>
        <ul>
          <li>To be a healthy and sustainable company.</li>
        </ul>
        <br>

        <h4 class="bg-primary text-white" style="width: 90%;">OUR Mision</h4>
        <ul>
