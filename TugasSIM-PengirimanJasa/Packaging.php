...
?>
  ...
  <body>
          ...
          <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-2">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="navbarDropdown">
                <li>
                  <a class="dropdown-item" style="background-color: #407BFF; color:white"><?php echo $row['nama'] ?></a>
                </li>
    ...
    <div class="container pt-md-50 pt-15 pb-20">
      <div class="row">
        <div class="col-md-15">
          <img src="image/Packaging.png" class="mx-auto d-block" alt="" width="30%">
        </div>
        ...
        <div class="position-relative">
          <div class="d-flex justify-content-center mt-4" style="position: relative; left: 50px;">
            <div class="col-md-4">
              <div class="btn-group">
                <a href="Packaging.php?id=<?php echo $row['id'] ?>" class="btn btn-dark">Guidance</a>
                <a href="Dangerous.php?id=<?php echo $row['id'] ?>" class="btn btn-dark">Dangerous Goods</a>
                <a href="Prohibited.php?id=<?php echo $row['id'] ?>" class="btn btn-dark">Prohibited</a>
    ...
    <footer class="footer d-flex justify-content-center" style="background-color: #1f1f1f; height: 50px;position: relative; top: 100px;">
      <div class="isi">
