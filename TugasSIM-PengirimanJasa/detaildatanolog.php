                ...
                <div class="d-flex justify-content-center mt-4">
                    <div class="col-md-6">
                        <div class="card text-black" style="background-color: white;">
                            <h1 class="card-header border border-black text-center text-white" style="background-color: #1f1f1f ;">Detail Data Pengiriman</h1>
                            <div class="card-body">
                                <br>
                                ...
                                <a role="button" class="btn btn-primary mt-4" href="index.php">Kembali</a>
