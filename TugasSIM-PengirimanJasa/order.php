...
require "functions.php";
    ...
    if (isset($_POST["tambah"])) {
        ...
        window.location.replace('kwitansi.php');
        </script>";
...
?>
    ...
    <head>
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <div class="col-md-8">
                            <div class="card text-black" style="background-color: white;">
                                <h1 class="card-header border border-black text-center text-white" style="background-color: #1f1f1f ;">Order</h1>
                                <div class="card-body">
                                    <br>
                                    <h5 class="fw-bold text-primary" >Sender Information</h5>
                                    <div class="form-order">
                                        <form style="display: grid; grid-template-columns: 1fr 1fr; grid-gap: 20px;" action="" method="POST" class="fw-bold">
                                            ...
                                            <br>
                                            <h5 class="fw-bold text-primary">Recipient Information</h5>
                                            <br>
                                            <div class="form-group mb-2">
                                                <label for="">Name</label>
                                            ...
                                            <br>
                                            <h5 class="fw-bold text-primary">Package Information</h5>
                                            <br>
                                            <div class="form-group mb-2">
                                            ...
                                            <button class="btn btn-primary mt-4" style="margin-left: 70%" type="submit" name="tambah">Order</button>
        ...
        <footer class="footer d-flex justify-content-center" style="background-color: #1f1f1f; height: 50px; position: relative; top: 30px;">
            <div class="isi">
